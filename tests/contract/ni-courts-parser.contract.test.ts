...
describe('NICourtsParser Contract', () => {
  ...
  describe('parse()', () => {
    ...
    it('should handle HTML parsing correctly', async () => {
      ...
      `;
      jest.spyOn(parser as unknown as { fetchHTML: () => Promise<string> }, 'fetchHTML').mockResolvedValue(mockHtml);
    ...
    it('should fail fast on network error', async () => {
      // Arrange
      jest.spyOn(parser as unknown as { fetchHTML: () => Promise<string> }, 'fetchHTML').mockRejectedValue(
    ...
    it('should fail fast on invalid HTML structure', async () => {
      ...
      jest.spyOn(parser as unknown as { fetchHTML: () => Promise<string> }, 'fetchHTML').mockResolvedValue(invalidHtml);
